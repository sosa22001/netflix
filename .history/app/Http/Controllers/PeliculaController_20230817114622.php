...
class PeliculaController extends Controller
{
    ...
    public function agregarContinuarViendo($idPerfil, $idPelicula, $idUsuario){
        ...
        return view('usuario.pelicula', compact('pelicula', 'idUsuario', 'perfil', 'perfiles', 'pelicRelacionadas', 'like'));
    }
    ...
    function popularidad($idPelicula){
        $cliente = new Client();
        ...
        $resultado = $cliente->get("http://localhost:8080/api/pelicula/popularidad/{$idPelicula}");

        $popularidad = json_decode($resultado->getBody());
